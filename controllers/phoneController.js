...
//   const IdCustomer = Customer.findOne({
//     where: { id_customer: req.body.customerIdCustomer },
//   }).then((data) => {
//     return data.dataValues.id_customer;
//   });
//   return IdCustomer;
// };
...
//       return res
//         .status(400)
//         .json({ error: true, message: "customerIdCustomer is required" });
//     }
...
//     };
//     console.log(modelData.customerIdCustomer);
